    ...
    <div className="steps max-w-4xl lg:mx-auto pt-10 px-4 lg:pt-0">
      <div className="step">
        ...
        <p className="text-gray-600 pb-8 max-w-96">
          Follow this simple step to get started and use this outstanding
          product
        </p>
      </div>
      ...
      <div className="step">
        ...
        <p className="text-gray-600 pb-8 max-w-96">
          Follow this step to start creating value for your customers
        </p>
      </div>
      <hr className="step-divider my-4 border-t-2 border-LabelEXP pb-8" />
      <div className="step">
  ...
  return (
    <div className="steps max-w-4xl lg:mx-auto pt-10 lg:pt-0">
      ...
      <div className="step w-full">
        <h2 className="text-2xl mb:pb-10 pb-3 font-medium mb-2">Step 3</h2>
        <p className="text-gray-600 pb-8 max-w-96">
          Now you're done and you've created something very special
        </p>
      </div>
    </div>
  );
