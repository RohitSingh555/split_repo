  ...
  const testimonials = [
    {
      ...
      rating: 5,
      comment:
        "I work remotely and explore on my own, now I can bring a new friend",
      name: "Aphiar Ivius",
    ...
    <>
      <div className="TestimonialContainer py-10 md:py-32 p-4 md:p-4">
        <div className="text-center mb-8">
          <h1 className="max-w-2xl mb-4 text-4xl font-bold m-auto tracking-tight leading-none md:text-5xl xl:text-6xl ">
            Testimonials
          </h1>
          <p className="text-gray-600">
            People love the service we offer and we want to let you know
          </p>
        </div>
